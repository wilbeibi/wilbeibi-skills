...
| [test-writing](skills/test-writing/SKILL.md) | Keep the committed suite small and semantic: find the stable seam, explore with properties, fuzzing, and model-based op sequences, and admit only contracts, invariants, compatibility, and minimized regressions in long-lasting table/testdata/script form. |
